(function () {
  ...
  function bitStates(values, registerMap, code) {
    ...
    return parseBitLabels(register.notes || []).map(([bit, label]) => ({
      label,
      value: (entry.raw & (1 << bit)) !== 0 ? "On" : "Off",
    }));
  }
  ...
  function deriveOverview(values, registerMap) {
    ...
    const [cmiValue, cmiDetail] = wordState(values, "CMI");
    return {
      hero: [
        { label: "Output frequency", value: formatRegisterValue(values, registerMap, "RFR") },
        { label: "Reference frequency", value: formatRegisterValue(values, registerMap, "LFR") },
        { label: "Output speed", value: formatRegisterValue(values, registerMap, "RFRD") },
        { label: "Mains voltage", value: formatRegisterValue(values, registerMap, "ULN") },
        { label: "Motor thermal", value: formatRegisterValue(values, registerMap, "THR") },
        { label: "Drive thermal", value: formatRegisterValue(values, registerMap, "THD") },
      ],
      states: [
        ...
        { label: "Command image", value: cmiValue, detail: cmiDetail },
        ...
        { label: "Active parameter set", value: formatRegisterValue(values, registerMap, "CFPS", { includeLabel: true }) },
      ],
      references: [
        { label: "Frequency ref", value: formatRegisterValue(values, registerMap, "FRH") },
        { label: "Torque ref", value: formatRegisterValue(values, registerMap, "TRR") },
        { label: "Internal PID ref", value: formatRegisterValue(values, registerMap, "RPI") },
        { label: "PID reference", value: formatRegisterValue(values, registerMap, "RPC") },
        { label: "PID feedback", value: formatRegisterValue(values, registerMap, "RPF") },
        { label: "PID error", value: formatRegisterValue(values, registerMap, "RPE") },
        { label: "PID output", value: formatRegisterValue(values, registerMap, "RPO") },
        { label: "Measured output", value: formatRegisterValue(values, registerMap, "MMF") },
      ],
      electrical: [
        { label: "Motor current", value: formatRegisterValue(values, registerMap, "LCR") },
        { label: "Motor voltage", value: formatRegisterValue(values, registerMap, "UOP") },
        { label: "Motor power", value: formatRegisterValue(values, registerMap, "OPR") },
        { label: "Motor torque", value: formatRegisterValue(values, registerMap, "OTR") },
        { label: "Consumption", value: formatRegisterValue(values, registerMap, "APH") },
        { label: "Average speed", value: formatRegisterValue(values, registerMap, "AVS") },
      ],
      thermal: [
        { label: "Motor thermal", value: formatRegisterValue(values, registerMap, "THR") },
        { label: "Drive thermal", value: formatRegisterValue(values, registerMap, "THD") },
        { label: "DB resistor thermal", value: formatRegisterValue(values, registerMap, "THB") },
        { label: "Run time", value: formatRegisterValue(values, registerMap, "RTH") },
        { label: "Power on time", value: formatRegisterValue(values, registerMap, "PTH") },
        { label: "IGBT alarm counter", value: formatRegisterValue(values, registerMap, "TAC") },
      ],
      analog: [
        { label: "AI1", value: formatRegisterValue(values, registerMap, "AI1C") },
        { label: "AI2", value: formatRegisterValue(values, registerMap, "AI2C") },
        { label: "AI3", value: formatRegisterValue(values, registerMap, "AI3C") },
        { label: "AI4", value: formatRegisterValue(values, registerMap, "AI4C") },
        { label: "AO1", value: formatRegisterValue(values, registerMap, "AO1C") },
        { label: "AO2", value: formatRegisterValue(values, registerMap, "AO2C") },
        { label: "AO3", value: formatRegisterValue(values, registerMap, "AO3C") },
      ],
      digitalBase: [...bitStates(values, registerMap, "IL1R"), ...bitStates(values, registerMap, "OL1R")],
      digitalCard: [...bitStates(values, registerMap, "PIL1"), ...bitStates(values, registerMap, "POL1")],
      diagnostics: [
        { label: "Last fault", value: formatRegisterValue(values, registerMap, "LFT", { includeLabel: true }) },
        { label: "Fault word", value: wordState(values, "ERRD")[0] },
        { label: "Network fault", value: formatRegisterValue(values, registerMap, "CNF", { includeLabel: true }) },
        { label: "Application fault", value: formatRegisterValue(values, registerMap, "APF", { includeLabel: true }) },
        { label: "Internal link 1", value: formatRegisterValue(values, registerMap, "ILF1") },
        { label: "Internal link 2", value: formatRegisterValue(values, registerMap, "ILF2") },
        { label: "Ethernet / card error", value: formatRegisterValue(values, registerMap, "ERR") },
        { label: "Fault counter", value: formatRegisterValue(values, registerMap, "FNB") },
      ],
      network: [
        { label: "Command channel", value: formatRegisterValue(values, registerMap, "CCC", { includeLabel: true }) },
        { label: "Reference channel", value: formatRegisterValue(values, registerMap, "CRC", { includeLabel: true }) },
  ...
  async function readMany(state, codes) {
    ...
    return { ok: true, values, bootstrap: bundle.bootstrap };
  }
